...
public class FormularioRutinasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSig.setOnClickListener(v -> {
            ...
            DatabaseReference current_user_db = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child(userID).child("Emergencias").push();
            ...
            Toast.makeText(FormularioRutinasActivity.this, "EMERGENCIA Y DATOS DEL PACIENTE REGISTRADOS:", Toast.LENGTH_LONG).show();
            finish();
