...
public class CreadorRutinaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSig.setOnClickListener(v -> {
            ...
            pulse = gameSettings.getString("pulso", "x");
            ...
            DatabaseReference current_user_db = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child("0BCEGU").child("Emergencias").push();
            ...
            map.put("mPulse", pulse);

            current_user_db.setValue(map);

            Toast.makeText(CreadorRutinaActivity.this, "EMERGENCIA RECIBIDA :" + date + "\\n"
