 ...
 */
public abstract class FirebaseAdapterEmergency<ViewHolder extends RecyclerView.ViewHolder, T>
        extends RecyclerView.Adapter<ViewHolder> {

    private Query mQuery;
    private Class<EmergencyObject> mItemClass;
    private ArrayList<EmergencyObject> mItems;
     ...
     */
    public FirebaseAdapterEmergency(Query query, Class<EmergencyObject> itemClass) {
     ...
     */
    public FirebaseAdapterEmergency(Query query, Class<EmergencyObject> itemClass,
                                    @Nullable ArrayList<EmergencyObject> items,
        ...
        if (items != null && keys != null) {
            ...
            mItems = new ArrayList<EmergencyObject>();
    ...
    private ChildEventListener mListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
            ...
            if (!mKeys.contains(key)) {
                EmergencyObject item = dataSnapshot.getValue(FirebaseAdapterEmergency.this.mItemClass);
                ...
                if (previousChildName == null) {
                    ...
                    if (nextIndex == mItems.size()) {
                        mItems.add(item);
                        Collections.sort(mItems, new Comparator<EmergencyObject>() {
                            @Override
                            public int compare(EmergencyObject o1, EmergencyObject o2) {
        ...
        public void onChildChanged(DataSnapshot dataSnapshot, String s) {
            ...
            if (mKeys.contains(key)) {
                ...
                EmergencyObject oldItem = mItems.get(index);
                EmergencyObject newItem = dataSnapshot.getValue(FirebaseAdapterEmergency.this.mItemClass);
        ...
        public void onChildRemoved(DataSnapshot dataSnapshot) {
            ...
            if (mKeys.contains(key)) {
                int index = mKeys.indexOf(key);
                EmergencyObject item = mItems.get(index);
    ...
    protected FirebaseAdapterEmergency() {
    }
     ...
     */
    public ArrayList<EmergencyObject> getItems() {
        return mItems;
    }
     ...
     * @return the item
     */
    public EmergencyObject getItem(int position) {
     ...
     */
    public int getPositionForItem(EmergencyObject item) {
     ...
     */
    public boolean contains(EmergencyObject item) {
     ...
     */
    protected abstract void itemAdded(EmergencyObject item, String key, int position);
     ...
     */
    protected abstract void itemChanged(EmergencyObject oldItem, EmergencyObject newItem, String key, int position);
     ...
     */
    protected abstract void itemRemoved(EmergencyObject item, String key, int position);
     ...
     */
    protected abstract void itemMoved(EmergencyObject item, String key, int oldPosition, int newPosition);
